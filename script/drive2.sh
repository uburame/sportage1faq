...
#crontab:
#0 12 */6 * * flock -xn /run/lock/drive2.lock -c '/mnt/data/drive2/drive2.sh'

log="/mnt/data/drive2/drive2.log"
list="/mnt/data/drive2/list.txt"
...
# Фильтрация:
cd /mnt/data/drive2/www.drive2.ru
...
cd /mnt/data/drive2/sportage1faq
git add . >> $log 2>&1
